            ...
            <header id="page-header">
                <div className="content-header">
                    <div className="d-flex align-items-center">
                        ...
                        <button type="button" className="btn btn-sm btn-dual mr-2" data-toggle="modal"
                                data-target="#one-modal-apps">
                            <i className="si si-grid"></i>
                        </button>

                        <button type="button" className="btn btn-sm btn-dual d-sm-none" data-toggle="layout"
                            ...
                            <div className="dropdown-menu dropdown-menu-right p-0 border-0 font-size-sm"
                                ...
                                <div className="p-3 text-center bg-primary">
                                    <img className="img-avatar img-avatar48 img-avatar-thumb"
                                         src="/assets/dashboard/media/avatars/avatar10.jpg" alt=""/>
                                </div>
                                <div className="p-2">
